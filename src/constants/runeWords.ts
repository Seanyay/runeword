...
const runeWords: IRuneWord[] = [
  ...
  {
    name: RuneWords.BLACK,
    runes: [THUL, IO, NEF],
    itemTypes: [ItemTypes.CLUBS, ItemTypes.HAMMERS, ItemTypes.MACES],
  ...
  {
    name: RuneWords.HOLY_THUNDER,
    runes: [ETH, RAL, ORT, TAL],
    itemTypes: [ItemTypes.SCEPTERS],
  ...
  {
    name: RuneWords.KINGS_GRACE,
    runes: [AMN, RAL, THUL],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.SCEPTERS],
  ...
  {
    name: RuneWords.SILENCE,
    runes: [DOL, ELD, HEL, IST, TIR, VEX],
    itemTypes: [ItemTypes.WEAPONS],
  ...
  },
  {
    ...
    runes: [TIR, EL],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.AXES, ItemTypes.MACES],
  ...
  {
    name: RuneWords.WHITE,
    runes: [DOL, IO],
    itemTypes: [ItemTypes.WANDS],
  ...
  {
    name: RuneWords.BEAST,
    runes: [BER, TIR, UM, MAL, LUM],
    itemTypes: [ItemTypes.AXES, ItemTypes.SCEPTERS, ItemTypes.HAMMERS],
  ...
  {
    name: RuneWords.BREATH_OF_THE_DYING,
  ...
  {
    name: RuneWords.CRESCENT_MOON,
    runes: [SHAEL, UM, TIR],
    itemTypes: [ItemTypes.AXES, ItemTypes.SWORDS, ItemTypes.POLEARMS],
  ...
  },
  {
    ...
    itemTypes: [ItemTypes.AXES, ItemTypes.POLEARMS, ItemTypes.HAMMERS],
  ...
  {
    name: RuneWords.EXILE,
    runes: [VEX, OHM, IST, DOL],
    itemTypes: [ItemTypes.PALADIN_SHIELDS],
  ...
  {
    name: RuneWords.FAMINE,
    runes: [FAL, OHM, ORT, JAH],
    itemTypes: [ItemTypes.AXES, ItemTypes.HAMMERS],
  ...
  {
    name: RuneWords.HAND_OF_JUSTICE,
  ...
  {
    name: RuneWords.HEART_OF_THE_OAK,
    runes: [KO, VEX, PUL, THUL],
    itemTypes: [ItemTypes.STAVES, ItemTypes.MACES],
  ...
  {
    name: RuneWords.KINGSLAYER,
    runes: [MAL, UM, GUL, FAL],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.AXES],
  ...
  {
    name: RuneWords.DESTRUCTION,
    runes: [VEX, LO, BER, JAH, KO],
    itemTypes: [ItemTypes.POLEARMS, ItemTypes.SWORDS],
  ...
  {
    name: RuneWords.DREAM,
    runes: [IO, JAH, PUL],
    itemTypes: [ItemTypes.HELMS, ItemTypes.SHIELDS],
  ...
  {
    name: RuneWords.INFINITY,
    runes: [BER, MAL, BER, IST],
    itemTypes: [ItemTypes.POLEARMS],
  ...
  {
    name: RuneWords.INSIGHT,
    runes: [RAL, TIR, TAL, SOL],
    itemTypes: [ItemTypes.POLEARMS, ItemTypes.STAVES],
  ...
  {
    name: RuneWords.LAST_WISH,
    runes: [JAH, MAL, JAH, SUR, JAH, BER],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.HAMMERS, ItemTypes.AXES],
  ...
  {
    name: RuneWords.LAWBRINGER,
    runes: [AMN, LEM, KO],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.HAMMERS, ItemTypes.SCEPTERS],
  ...
  {
    name: RuneWords.PHOENIX,
    runes: [VEX, VEX, LO, JAH],
    itemTypes: [ItemTypes.WEAPONS, ItemTypes.SHIELDS],
  ...
  },
  {
    ...
    itemTypes: [ItemTypes.POLEARMS, ItemTypes.SCEPTERS],
  ...
  },
  {
    ...
    runes: [LEM, KO, EL, ELD],
    itemTypes: [ItemTypes.SWORDS, ItemTypes.MACES],
  ...
  // 2.4 runewords
  {
    name: RuneWords.FLICKERING_FLAME,
    runes: [NEF, PUL, VEX],
    itemTypes: [ItemTypes.HELMS],
    attributes: ["Level 8 Resist Fire Aura When Equipped", "+3 to Fire Skills", "-13% to Enemy Fire Resistance", "+30% Enhanced Defense", "+30 Defense vs. Missile", "+88 to Mana", "+5% to Maximum Fire Resist", "Half Freeze Duration", "Poison Length Reduced to 50%"],
    level: 64,
    ladderOnly: true
  },
  {
